<?php
	...
	$json = file_get_contents('http://localhost/todo_sexta/api/?tarefastatus=1');
...
<head>
	...
	<script>
		...
		function realizarTarefa(id) {
			location.href = 'index.php?pagina=index&acao=concluirTarefa&id=' + id;
		}

		function excluirTarefa(id) {
			location.href = 'index.php?pagina=index&acao=excluirTarefa&id=' + id;
		}
